                ...
                >
                        <Box mx={1} display="block" alignItems="center" color="white" borderRadius={borders.borderRadius.lg} bgColor={colors.white.main}>
                                ...
                                {showSimilarityButton ?
                                        <Box p={1} display="flex" justifyContent='space-between'>
                                                <Box display="flex">
                                                        <EqualizerOutlined sx={{ color: colors.white.main }} />
                                                        <Typography fontWeight="light" color="white" fontSize={'15px'} px={1} sx={{ color: colors.white.main }}>Cluster</Typography>
                                                </Box>
                                                <Typography fontWeight="light" color="white" fontSize={'15px'} px={1} sx={{ color: colors.white.main }}>{cluster}</Typography>
                                        </Box>
                                        :
                        ...
                        {showSimilarityButton && (
                                <Button
                                        ...
                                        }}>{isLoading ? <CircularProgress size={24} sx={{ color: colors.white.main }} /> : 'Show Similarity'}</Button>
                        )}
                </Box>
        );
}
